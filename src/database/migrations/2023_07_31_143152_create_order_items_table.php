...
class CreateOrderItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_items', function (Blueprint $table) {
            ...
            $table->decimal('amazing_sale_discount_amount',20)->nullable();
            ...
            $table->decimal('final_product_price',20)->nullable();
            $table->decimal('final_total_price',20)->nullable()->comment('number * final_product_price');
