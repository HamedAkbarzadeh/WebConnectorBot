...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->decimal('delivery_amount', 20)->nullable();
            $table->tinyInteger('delivery_status')->nullable();
            $table->timestamp('delivery_date')->nullable();
            $table->decimal('order_final_amount', 20)->nullable();
            $table->decimal('order_discount_amount', 20)->nullable();
            ...
            $table->decimal('order_copan_discount_amount', 20)->nullable();
            ...
            $table->decimal('order_common_discount_amount', 20)->nullable();
            $table->decimal('order_total_products_discount_amount', 20)->nullable();
